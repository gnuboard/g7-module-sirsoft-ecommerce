 ...
 * 상품 라벨 수정 요청
 */
class ProductLabelUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => ['sometimes', 'required', 'array', new LocaleRequiredTranslatable(maxLength: 50)],
            'color' => 'sometimes|required|string|max:20|regex:/^#[0-9A-Fa-f]{6}$/',
