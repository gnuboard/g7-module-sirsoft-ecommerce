 ...
 * 상품정보제공고시 템플릿 생성 요청
 */
class StoreProductNoticeTemplateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        // 훅을 통한 동적 규칙 확장
        return HookManager::applyFilters('sirsoft-ecommerce.product-notice-template.create_validation_rules', $rules, $this);
    }
