 ...
 * 공통정보 생성 요청
 */
class StoreProductCommonInfoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        // 훅을 통한 동적 규칙 확장
        return HookManager::applyFilters('sirsoft-ecommerce.product-common-info.create_validation_rules', $rules, $this);
    }
