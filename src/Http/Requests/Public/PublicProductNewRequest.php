 ...
 * 신상품 목록 조회 요청 (공개)
 *
 * 신상품 조회 시 반환 개수 제한 파라미터를 검증합니다.
 */
class PublicProductNewRequest extends FormRequest
{
    /**
     * 권한 확인
     *
    ...
    public function rules(): array
    {
        ...
        return HookManager::applyFilters('sirsoft-ecommerce.product.public_new_validation_rules', $rules, $this);
    }
